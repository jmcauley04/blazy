...
namespace Blazy.Services.JS
{
    public abstract class BaseJsModule
    {
        ...
        public bool IsImported => module != null;
        ...
        public async Task Import()
        {
            if (module is null)
            {
                if (wwwrootpath is not null)
                {
                    ...
                    if (module is null)
                    {
                        throw new FileNotFoundException($"The JS file at ./_content/Blazy/{wwwrootpath} could not be found");
                    }
                }
        ...
        protected Exception NullModuleException()
        {
            return new NullReferenceException($"The javascript module you are referencing is null");
        }
    }
}
